...
const SECTIONS = [
  { id: "1", icon: "check-circle", color: "#0ECB81", title: "Acceptance of Terms", body: `By accessing or using CryptoX Exchange ("the Platform"), you agree to be bound by these Terms and Conditions. If you do not agree, please do not use the Platform.\n\nThese Terms constitute a legally binding agreement between you and CryptoX Exchange Ltd. ("CryptoX"). These Terms apply to all visitors, users, and others who access or use the Platform.` },
  { id: "2", icon: "user-check", color: "#628EEA", title: "Eligibility", body: `You must be at least 18 years of age to use CryptoX. By using the Platform, you represent and warrant that:\n\n• You are at least 18 years old\n• You have the legal capacity to enter into a binding contract\n• You are not prohibited from using financial services under applicable law\n• You are not a resident of a jurisdiction where cryptocurrency trading is prohibited\n• Your use will not violate any applicable laws or regulations` },
  ...
  { id: "6", icon: "briefcase", color: "#0ECB81", title: "Wallet & Custody", body: `CEX Wallet (Custodial): Assets are held by CryptoX on your behalf. We maintain private keys and are responsible for security.\n\nDEX Wallet (Self-Custody): Your private keys are stored locally on your device. CryptoX does not have access. You are solely responsible for securing your wallet. Loss of your seed phrase means permanent loss of access.\n\nAlways verify wallet addresses before any transaction. CryptoX is not liable for funds sent to incorrect addresses.` },
  { id: "7", icon: "dollar-sign", color: "#628EEA", title: "Fees & Charges", body: `CryptoX charges fees for certain services. Fee schedules are available on the Platform and may be updated. By using the Platform, you agree to pay all applicable fees.\n\n• Trading fees: Applied to all completed spot trades\n• Withdrawal fees: Network gas fees plus platform fee\n• Swap fees: Included in the exchange rate\n• Staking fees: Performance fee on staking rewards` },
    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        <View style={[styles.hero, { backgroundColor: colors.card, borderBottomColor: colors.border }]}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={[styles.heroTitle, { color: colors.foreground }]}>CryptoX Exchange</Text>
        ...
        <View style={{ padding: 16, gap: 6 }}>
          <Text style={[styles.intro, { color: colors.mutedForeground }]}>
            Please read these Terms carefully before using CryptoX Exchange. Tap any section to read the full terms.
          </Text>
